...
if ( ! function_exists( 'psrm_paging_nav' ) ) :
/**
 * Display navigation to next/previous set of posts when applicable.
 */
function psrm_paging_nav() {
	...
	<nav class="navigation paging-navigation" role="navigation">
		<h1 class="screen-reader-text"><?php _e( 'Posts navigation', 'psrm' ); ?></h1>
		<div class="nav-links">

			<?php if ( get_next_posts_link() ) : ?>
			<div class="nav-previous"><?php next_posts_link( __( '<span class="meta-nav">&larr;</span> Older posts', 'psrm' ) ); ?></div>
			<?php endif; ?>

			<?php if ( get_previous_posts_link() ) : ?>
			<div class="nav-next"><?php previous_posts_link( __( 'Newer posts <span class="meta-nav">&rarr;</span>', 'psrm' ) ); ?></div>
			<?php endif; ?>
...
if ( ! function_exists( 'psrm_post_nav' ) ) :
/**
 * Display navigation to next/previous post when applicable.
 */
function psrm_post_nav() {
...
if ( ! function_exists( 'psrm_posted_on' ) ) :
/**
...
if ( ! function_exists( 'psrm_entry_footer' ) ) :
/**
...
/**
 * Flush out the transients used in psrm_categorized_blog.
 */
function psrm_category_transient_flusher() {
	// Like, beat it. Dig?
	delete_transient( 'psrm_categories' );
}
add_action( 'edit_category', 'psrm_category_transient_flusher' );
add_action( 'save_post',     'psrm_category_transient_flusher' );
